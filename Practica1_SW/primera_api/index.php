...
$app->post("/insertarProducto",function($request){
    
    echo json_encode(insertar($request["cod"], $request["nombre"], $request["nombre_corto"], $request["descripcion"], $request["PVP"], $request["familia"]));
});
