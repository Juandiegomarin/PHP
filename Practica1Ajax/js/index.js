    ...
    $.ajax({
        ...
        .done(function (data) {
            if (data.mensaje_error) {
                ...
                var html_output = "<table><tr><th>COD</th><th>Nombre corto</th><th>PVP</th><th><button onclick ='nuevo_producto()' class='enlace'>Insertar</button></th></tr>"
...
function comprobar_editar(cod)
{
    ...
    var nombre_corto=$('#nombre_corto').val();
    $.ajax({
        url:encodeURI(DIR_SERV+"/repetidoEditando/producto/nombre_corto/"+nombre_corto+"/cod/"+cod),
        type:"GET",
        dataType:"json"
    })
    .done(function(data){
